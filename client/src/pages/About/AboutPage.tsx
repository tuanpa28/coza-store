...
const AboutPage = () => {
  return (
    <>
      <HeaderTop />
      <div>
        <div style={{backgroundImage: ("https://res.cloudinary.com/dugodumc5/image/upload/v1685350444/coza-store/mmvjenxfu1eh3aymguup.webp")}} className="banner">
          <h2>About</h2>
        </div>
        {/* <!-- end banner --> */}
        <div id="alll" className="sub-about">
          <div className="about">
            <div className="flex justify pb-37">
              <div className="title">
                <h3>Our Story</h3>
                <p>
              ...
              <div className="sub-img">
                <div className="sub-img-bor">
                  <div className="sub-img-two">
                    <img
                      src="https://res.cloudinary.com/dugodumc5/image/upload/v1685350445/coza-store/ixdffzvwsq2g8xnnfqal.webp"
                      alt=""
                    />
                  </div>
                </div>
            ...
            <div className="flex justify">
              <div className="sub-img">
                <div className="sub-img-bor-2">
                  <div className="sub-img-two-2">
                    <img
                      src="https://res.cloudinary.com/dugodumc5/image/upload/v1685350458/coza-store/m4jsvy0ulal2nlrkr0bu.webp"
                      alt=""
                    />
                  </div>
                </div>
              ...
              <div className="title">
                ...
                <div className="mt-6 bor-l pl-7">
                  ...
                  <span className="pt-">- Steve Job’s</span>
                </div>
              </div>
            </div>
          </div>
